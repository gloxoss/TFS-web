...
import { Search, Sun, Settings, Bell, Plus } from "lucide-react";

import { AcmeIcon } from "../shared/acme-icon";
import NotificationsCard from "../shared/notifications-card";

export default function NavigationHeaderWithHeadingCTA() {
    return (
                ...
                <NavbarContent className="ml-auto h-12 max-w-fit items-center gap-0" justify="end">
                    <NavbarItem className="mr-2 hidden lg:flex">
                        <Input
                            ...
                            radius="full"
                            startContent={
                                <Search className="text-default-500" width={20} />
                            }
                        />
                    </NavbarItem>
                    {/* Mobile search */}
                    ...
                    <NavbarItem className="hidden lg:flex">
                        <Button isIconOnly radius="full" variant="light">
                            <Sun className="text-default-500" width={24} />
                        </Button>
                    </NavbarItem>
                    {/* Settings */}
                    <NavbarItem className="hidden lg:flex">
                            ...
                            <PopoverTrigger>
                                ...
                                >
                                    <Badge color="danger" content="5" showOutline={false} size="md">
                                        <Bell className="text-default-500" width={22} />
                                    </Badge>
                                </Button>
                            </PopoverTrigger>
                ...
                <div className="w-full max-w-[1024px] px-4 lg:px-8">
                    <header className="mb-6 flex w-full items-center justify-between">
                        ...
                        <Button
                            ...
                            startContent={
                                <Plus className="flex-none text-background/60" width={16} />
                            }
                        >
                            New Deployment
                        </Button>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Tooltip content="New deployment" placement="bottom">
                                <Button isIconOnly radius="full" size="sm" variant="faded">
                                    <Plus className="text-default-500" width={16} />
                                </Button>
                            </Tooltip>
                        </div>
                    </ScrollShadow>
