...
import PricingRadioItem from "./PricingRadioItem";

export default function SimplePricingSelector() {
    const [selectedFrequency, setSelectedFrequency] = React.useState(frequencies[0]);
    const [selectedTier, setSelectedTier] = React.useState<string>(tiers[0].key);
