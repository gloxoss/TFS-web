...
export default function PricingComparisonWithFeaturedTierFilled() {
                        ...
                        <CardBody className="gap-8">
                            <p className="flex items-baseline gap-1 pt-2">
                                ...
                                {typeof tier.price !== "string" ? (
                                    <span
                                        className={cn("text-small font-medium text-default-400", {
                                ...
                                {tiers.map((tier) => (
                                    <th key={tier.key} className="px-6 pt-6 xl:px-8 xl:pt-8" scope="col">
                                        <div className="relative">
                                            <div
                                                className={cn("text-large font-medium text-foreground", {
                                                    "text-primary": tier.mostPopular,
                                                })}
                                            >
                                                {tier.title}
                                            </div>
                                            {tier.mostPopular ? (
                                                <Chip
                                                    classNames={{
                                                        base: "absolute -top-3 left-[4.5rem]",
                                                    ...
                                                    {typeof tierFeature.tiers[tier.key] === "string" ? (
                                                        ...
                                                        <>
                                                            {tierFeature.tiers[tier.key] === true ? (
                                                                <Check className="mx-auto text-primary" width={24} />
                                                            ) : (
                                                                <X
