...
export default function LeftSignUpWithRightTestimonial() {
        ...
        <div className="relative flex h-full min-h-[48rem] w-full">
            ...
            <div className="flex w-full items-center justify-center bg-background lg:w-1/2">
                <div className="flex w-full max-w-sm flex-col items-center gap-4 p-4">
                    ...
                    <Form className="flex w-full flex-col gap-3" validationBehavior="native" onSubmit={(e) => e.preventDefault()}>
                        <Input
                            isRequired
                            label="Email Address"
                            name="email"
