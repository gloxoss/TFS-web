...
import { Link as LinkIcon, PlusCircle, ArrowUpRight } from "lucide-react";
import { cn } from "@heroui/react";

import TeamManageTable from "./team-manage-table";

interface TeamSettingCardProps extends React.HTMLAttributes<HTMLDivElement> {
    className?: string;
}
                ...
                <CardBody className="px-4">
                    <div className="flex items-start justify-between pb-3">
                        ...
                        <Button
                            ...
                            endContent={<LinkIcon className="h-3 w-3" />}
                            radius="md"
                            size="sm"
                        >
                            Invite Link
                    ...
                    <div className="py-2">
                        ...
                        <Button
                            ...
                            endContent={<PlusCircle className="h-[18px] w-[18px]" />}
                            radius="md"
                            size="sm"
                        >
                            Add more
