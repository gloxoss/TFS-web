...
export default function PricingWithBlurredBackground() {
    ...
    return (
        <div className="relative flex max-w-4xl flex-col items-center py-24">
            ...
            <div className="flex max-w-xl flex-col text-center z-10">
            ...
            <Spacer y={12} />
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 z-10">
                {tiers.map((tier) => (
                    <Card
                        key={tier.key}
                        isBlurred
