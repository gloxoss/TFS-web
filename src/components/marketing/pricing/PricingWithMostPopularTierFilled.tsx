...
export default function PricingWithMostPopularTierFilled() {
                ...
                {tiers.map((tier) => (
                    ...
                    >
                        {tier.mostPopular ? (
                            <Chip
                                classNames={{
                                    base: "absolute -top-3 left-1/2 -translate-x-1/2 z-10 bg-primary-foreground shadow-large border-medium border-primary",
