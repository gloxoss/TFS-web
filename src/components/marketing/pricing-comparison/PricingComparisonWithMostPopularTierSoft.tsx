...
export default function PricingComparisonWithMostPopularTierSoft() {
    ...
    const highlightedTierColumnBg = "bg-primary-50 dark:bg-primary/20";
                            ...
                            <ul className="flex flex-col gap-2">
                                {tier.features?.map((feature) => (
                                    <li key={feature} className="flex items-center gap-2">
                                        <Check className="text-primary" width={24} />
                        ...
                        <thead>
                            <tr>
                                ...
                                {tiers.map((tier) => (
                                    <th
                                        key={tier.key}
                                        className={cn("px-6 pt-6 xl:px-8 xl:pt-8", {
                                            [`${highlightedTierColumnBg} rounded-t-medium`]: tier.mostPopular,
                                        })}
                                        scope="col"
                                    >
                                        <div className="relative">
                                            <div className="text-large font-medium text-foreground">{tier.title}</div>
                                            {tier.mostPopular ? (
                                                <Chip
                                                    classNames={{
                                                        base: "absolute -top-4 right-0",
                                                        content: "font-medium text-primary-500 dark:text-primary-600",
                                                    }}
                                                    color="primary"
                                                    variant="flat"
                            ...
                            <tr>
                                ...
                                {tiers.map((tier) => (
                                    <td
                                        key={tier.key}
                                        className={cn("px-6 pt-4 xl:px-8", {
                                            [`${highlightedTierColumnBg}`]: tier.mostPopular,
                                        })}
                                    >
                                        ...
                                        <tr key={tierFeature.title}>
                                            ...
                                            {tiers.map((tier) => {
                                                ...
                                                return (
                                                    <td
                                                        key={tier.key}
                                                        className={cn("px-6 py-4 xl:px-8", {
                                                            [`${highlightedTierColumnBg} ${isLastOne ? "rounded-b-medium" : ""}`]:
                                                                tier.mostPopular,
                                                        })}
                                                    >
