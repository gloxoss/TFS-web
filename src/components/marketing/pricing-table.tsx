 ...
 * PricingTable
 * 
 * A 3-column pricing table with a "Most Popular" highlighted tier.
 * Migrated from Tailwind UI "Three tiers".
 */
export default function PricingTable({
    ...
    return (
        <div className={cn("bg-white py-24 sm:py-32 dark:bg-gray-900", className)}>
                                ...
                                <ul role="list" className="mt-8 space-y-3 text-sm/6 text-gray-600 dark:text-gray-400">
                                    {tier.features.map((feature) => (
                                        <li key={feature} className="flex gap-x-3">
                                            <Check aria-hidden="true" className="h-6 w-5 flex-none text-indigo-600 dark:text-indigo-400" />
                                            {feature}
                                        </li>
                                    ))}
                                </ul>
                            ...
                            <Link
                                ...
                                className={cn(
                                    tier.mostPopular
                                        ...
                                        : 'text-indigo-600 ring-1 ring-indigo-200 ring-inset hover:ring-indigo-300 dark:text-indigo-400 dark:ring-indigo-700 dark:hover:ring-indigo-600',
