...
export default function InvertedBanner() {
    return (
        <div className="flex w-full items-center gap-x-3 border-b-1 border-divider bg-foreground px-6 py-2 backdrop-blur-xl sm:px-3.5 sm:before:flex-1">
            ...
            <Button
                as={Link}
                className="group relative h-9 overflow-hidden bg-transparent text-small font-normal text-background"
                color="default"
                endContent={
                    <ArrowRight
            ...
            <div className="flex flex-1 justify-end">
                <Button isIconOnly className="-m-1" size="sm" variant="light">
                    ...
                    <X className="text-background/50" size={20} />
                </Button>
            </div>
        </div>
    );
