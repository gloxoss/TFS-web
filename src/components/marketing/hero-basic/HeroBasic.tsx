                ...
                <section className="z-20 flex flex-col items-center justify-center gap-[18px] sm:gap-6">
                    ...
                    <div className="text-center text-[clamp(40px,10vw,44px)] font-bold leading-[1.2] tracking-tighter sm:text-[64px]">
                        <div className="bg-hero-section-title bg-clip-text text-transparent from-foreground to-foreground/50 bg-gradient-to-b">
                            {/* Note: bg-hero-section-title might be a custom utility in the original kit. 
                  I replaced with a standard gradient for now to ensure visibility. 
                  Original was: bg-hero-section-title bg-clip-text text-transparent
              */}
                ...
                <div className="pointer-events-none absolute inset-0 top-[-25%] z-10 scale-150 select-none sm:scale-125 opacity-50">
                    {/* Image source needs to be valid. Using the original URL. */}
                    <FadeInImage
                        fill
                        priority
